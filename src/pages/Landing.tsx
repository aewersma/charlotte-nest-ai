      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Find Your Perfect<br />Charlotte Neighborhood
          </h1>
          <p className="text-xl md:text-2xl mb-10 text-white/95 max-w-2xl mx-auto">
            AI-powered recommendations matched to your lifestyle, family needs, and budget
          </p>
          <Button 
            variant="hero" 
            size="xl"
      ...
      <div className="py-24 px-6 bg-gradient-to-b from-background to-muted/30">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-foreground">
            Why Choose Charlotte Neighborhood Finder?
          </h2>
      ...
      <div className="py-20 px-6 bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            Join hundreds of families who've found their perfect Charlotte home
          </p>
          <Button 
            variant="hero" 
            size="xl"
